...
<p><strong>PRIVACY POLICY AND CONSUMER EDUCATIO</strong>N
  <br />In order to use the Services, you agree to be bound by the Privacy Policy of the Site. Please review the Privacy Policy (which may be accessed at the Site) on a regular basis as it may be updated from time to time.</p>
<p><strong>COPYRIGHTS</strong>
  <br />Unless otherwise indicated, all Site non content materials, including, without limitation, the Site logo, and all designs, text, graphics, other non content files, and the selection and arrangement thereof are the proprietary and copyrighted property of the Site. You may electronically copy and print to hard copy portions of this Site for the sole purpose of using materials it contains for informational and non-commercial, personal use only. Any other use of the materials in this Site that originated from us – including any commercial use, reproduction for purposes other than described above, modification, distribution, republication, display or performance – without the prior written permission of us is strictly prohibited.</p>
<p><strong>TRADEMARKS</strong>
  <br />The Site name and logo are our trademarks, and may not be copied, imitated or used, in whole or in part, without our prior written permission. In addition, all page headers, custom graphics, button icons and scripts are service marks, trademarks and/or trade dress of the Site, and may not be copied, imitated or used, in whole or in part, without our prior written permission.</p>
<p><strong>USE OF CONTENT SUBMITTED BY YOU/USER/AUTHOR</strong>
  <br />BY UPLOADING, POSTING, SENDING OR SUBMITTING PHOTOGRAPHS, PICTURES, IMAGES OR ANY OTHER CONTENT INCLUDING, WITHOUT LIMITATION, GRAPHICS, VIDEO, DATA, TEXT, FILES, LINKS, SOFTWARE, MUSIC, SOUND (“CONTENT”), YOU ARE CONSENTING TO BE BOUND BY THESE TERMS OF USE. IF YOU DO NOT AGREE, DO NOT UPLOAD, POST, SEND OR SUBMIT ANY CONTENT TO THIS SITE.</p>
...
<p>We may provide links to web pages and content of third parties (“Third Party Content”) as a service to those interested in this information. We do not monitor, nor does it have any control over, any Third Party Content. We do not endorse or adopt any Third Party Content and can make no guarantee as to its accuracy or completeness. We make no representations or warranties of any kind regarding such Third Party Content, or any information contained therein, and undertakes no responsibility to update or review any Third Party Content.
  <br />When leaving the Site, you should be aware that the TOS no longer govern, and, therefore, you should review the applicable terms and policies, including privacy and data gathering practices, of that particular site. Users use these links and Third Party Content contained therein at their own risk.</p>
...
<blockquote>
  <p>Copyright Agent
    <br />John Edhoy
    contact@<?php echo $_SERVER['SERVER_NAME'] ?>
...
<ul>
  ...
  <p>Should you fail to comply with all of the aforementioned requirements in your notice, your notice may not be valid.</p>
...
<p><strong>TERMINATION</strong>
  <br />In the event that you are a registered user of the Site, you may terminate such registration by notifying the Site by sending e-mail to <a class="__cf_email__" href="/cdn-cgi/l/email-protection" data-cfemail="620b0c045d2207030b0a070e124c010d0f4c">[email&#160;protected]</a>
  After receipt of your termination notice, we will terminate your account.
  <br />We may terminate your access to the Services or your registration at any time in the event of a breach of these TOS by User or anyone accessing the Services using registered User’s username. We, at our sole discretion, may also terminate these TOS at any time without cause, and may suspend access to the Service with or without notice, to any User.</p>
<p><strong>INDEMNIFICATION</strong>
  <br />User agrees to indemnify and hold us, our parents, friends, affiliates, officers and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third party due to or arising out of User’s use of the Site, the violation of these TOS by User, or the infringement by User, or any other user of User’s account, of any intellectual property or other right of any person or entity.
  <br />DISCLAIMER OF WARRANTIES
  <br />YOU EXPRESSLY UNDERSTAND AND AGREE THAT:</p>
<p>
  ...
  <p>NO ADVICE OR INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED BY YOU FROM US OR THE SITE OR THROUGH OR FROM THE SERVICE SHALL CREATE ANY WARRANTY NOT EXPRESSLY STATED IN THE TOS.</p>
